...
/* harmony import */ var _news__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./news */ "./app/js/news.js");
//import 'whatwg-fetch'
...
document.querySelector('.sel-cat').addEventListener('change', function (e) {
  ...
  _api__WEBPACK_IMPORTED_MODULE_0__["NewsApi"].getSourcesOnCategory(selectedCategory).then(function (sources) {
...
function renderSources(elemId, sources) {
  ...
  if (elem && sources.status == 'ok') {
    ...
    document.querySelector('#news-sources ul').addEventListener('click', function (e) {
      ...
      _api__WEBPACK_IMPORTED_MODULE_0__["NewsApi"].getNewsOnSource(newsSrc).then(function (news) {
        Object(_news__WEBPACK_IMPORTED_MODULE_1__["renderNews"])(newsContainer, news);
      });
    });
  }
}
...
/***/ 0:
/*!***************************************************************************************!*\
  !*** multi whatwg-fetch @babel/polyfill nodelist-foreach-polyfill ./app/js/common.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! ./app/js/common.js */"./app/js/common.js");
